...
CREATE TABLE IF NOT EXISTS `prueba_cuentas`.`persona` (
  ...
  INDEX `fk_TPERSONA_CGENERO1_idx` (`genero` ASC) VISIBLE,
...
INSERT INTO `prueba_cuentas`.`genero` (`nombre`) VALUES ('FEMENINO');
INSERT INTO `prueba_cuentas`.`genero` (`nombre`) VALUES ('MASCULINO');

INSERT INTO `prueba_cuentas`.`tipo_movimiento` (`nombre`) VALUES ('RETIRO');
INSERT INTO `prueba_cuentas`.`tipo_movimiento` (`nombre`) VALUES ('DEPOSITO');

INSERT INTO `prueba_cuentas`.`tipo_cuenta` (`nombre`) VALUES ('AHORRO');
INSERT INTO `prueba_cuentas`.`tipo_cuenta` (`nombre`) VALUES ('CORRIENTE');
