...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `prueba_cuentas` ;
...
CREATE TABLE IF NOT EXISTS `prueba_cuentas`.`genero` (
  `pk_genero` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `prueba_cuentas`.`persona` (
  `pk_persona` BIGINT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
  `edad` INT NOT NULL,
  `identificacion` VARCHAR(45) NOT NULL,
  `direccion` VARCHAR(45) NOT NULL,
  `telefono` VARCHAR(45) NOT NULL,
  `fk_genero` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `prueba_cuentas`.`tipo_cuenta` (
  `pk_tipo_cuenta` BIGINT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `prueba_cuentas`.`cuenta` (
  `pk_cuenta` BIGINT NOT NULL AUTO_INCREMENT,
  `numero_cuenta` VARCHAR(45) NOT NULL,
  `saldo_inicial` DOUBLE NOT NULL,
  `fk_cliente` BIGINT NOT NULL,
  `fk_tipo_cuenta` BIGINT NOT NULL,
  `estado` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `prueba_cuentas`.`tipo_movimiento` (
  `pk_tipo_movimiento` BIGINT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `prueba_cuentas`.`movimiento`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `prueba_cuentas`.`movimiento` ;

CREATE TABLE IF NOT EXISTS `prueba_cuentas`.`movimiento` (
  `pk_movimiento` BIGINT NOT NULL AUTO_INCREMENT,
  `fecha` DATETIME NOT NULL,
  `valor` DOUBLE NOT NULL,
  `saldo` DOUBLE NOT NULL,
  `fk_cuenta` BIGINT NOT NULL,
  `fk_tipo_movimiento` BIGINT NOT NULL,
